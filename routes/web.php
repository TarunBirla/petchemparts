...
use App\Models\Category;
    ...
    // });
            ...
            // show renew form
       Route::get('user/order/{id}/renew', [OrderController::class, 'renewForm'])
    ->name('user.order.renew');

        
        // handle renew POST
        Route::post('user/order/{id}/renew', [OrderController::class, 'renewUpdate'])->name('user.order.renew.update');
       



 Route::view('/frontend/showcategory', 'frontend.showcategory');
  Route::view('/frontend/showproduct', 'frontend.showproduct');
 Route::view('/frontend/aboutus', 'frontend.aboutus');
 Route::view('/frontend/checkout', 'frontend.checkout');
 Route::view('/frontend/contact', 'frontend.contact');
 Route::view('/frontend/termcondition', 'frontend.termcondition');
 
 
Route::get('/shop', [FrontendController::class, 'manufacturerData'])->name('shop');

Route::get('/', [FrontendController::class, 'manufacturerindex'])->name('home');
